...
import { StoryId, useParameter, useStorybookApi } from '@storybook/api';
import { Story } from '@storybook/store';

import { SourceContext, SourceContextProps } from './SourceContainer';
import { CURRENT_SELECTION, SourceType } from './constants';
...
export const getSourceProps = (
  ...
  const currentData = api.getCurrentStoryData() as unknown as Story;
  const currentId = currentData.id;
  const docsParameters = useParameter<any>('docs', {});
...
export const Source: FC<SourceProps> = (props) => {
  ...
  const sourceProps = getSourceProps(props, sourceContext);
