...
type FileTypeKnobValue = string[];

export interface FileTypeKnob {
  name: string;
  accept: string;
  value: FileTypeKnobValue;
  onChange: (obj: { value: unknown; type: 'text'; name: string }) => void;
}

export interface FilesTypeProps {
  knob: FileTypeKnob;
  onChange: (value: FileTypeKnobValue) => FileTypeKnobValue;
}
