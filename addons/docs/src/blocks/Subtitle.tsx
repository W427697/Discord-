...
import { Subtitle as PureSubtitle, docsEscapeHatch } from '@storybook/components';
...
export const Subtitle: FunctionComponent<SubtitleProps> = ({ slot, children }) => {
  ...
  return text ? <PureSubtitle className={docsEscapeHatch(Subtitle)}>{text}</PureSubtitle> : null;
};
