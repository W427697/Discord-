...
import { DocsWrapper, DocsContent, docsEscapeHatch } from '@storybook/components';
    ...
    <DocsContext.Provider value={context}>
      <ThemeProvider theme={theme}>
        <MDXProvider components={allComponents}>
          <DocsWrapper className={docsEscapeHatch(DocsWrapper)}>
            <DocsContent className={docsEscapeHatch(DocsContent)}>{children}</DocsContent>
          </DocsWrapper>
        </MDXProvider>
      </ThemeProvider>
