...
export default async ({
  ...
  return {
    ...
    // cache passes an empty object? needs to be a bool, or {type:"memory"} for dev, you can use type:filesysem for prod builds
    ...
    module: {
      rules: [
        //fix incorrectly configured package.json paths
        {
          test: /\.m?js$/,
