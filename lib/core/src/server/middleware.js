...
export default function(configDir, loadConfig, getBaseConfig, appMiddleware = []) {
  ...
  // apply middleware for the app level
  appMiddleware.forEach(middleware => router.use(middleware()));
