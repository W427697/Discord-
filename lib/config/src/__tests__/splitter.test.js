...
// const cacheDir = '../__mocks__/cache';
...
//   console.log(require.resolve('../__mocks__/storybook.config.js'));
//   const result = await splitter({
//     file: require.resolve('../__mocks__/storybook.config.js'),
//     // cacheDir,
//     config: {
...
//     expect.stringContaining('/.cache/manager.config.js'),
//     expect.any(String),
//     expect.any(Function)
//   );

//   expect(fs.writeFile).toHaveBeenCalledWith(
//     expect.stringContaining('/.cache/preview.config.js'),
//     expect.any(String),
//     expect.any(Function)
//   );
// });

// test.only('cacheDir', async () => {
//   const result = await splitter({
