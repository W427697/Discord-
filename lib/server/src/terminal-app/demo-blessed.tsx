...
//   let grid = new contrib.grid({ rows: 12, cols: 12, screen: s });
...
//  */
//   let donut = grid.set(8, 8, 4, 2, contrib.donut, {
//     radius: 16,
//     arcWidth: 4,
//     yPadding: 2,
//     data: [
...
//   let gauge = grid.set(8, 10, 2, 2, contrib.gauge, { label: 'Storage', percent: [80, 20] });
//   let gauge_two = grid.set(2, 9, 2, 3, contrib.gauge, {
...
//   let bar = grid.set(4, 6, 4, 3, contrib.bar, {
...
//   let table = grid.set(4, 9, 4, 3, contrib.table, {
//     keys: true,
//     fg: 'green',
...
// */
//   let lcdLineOne = grid.set(0, 9, 2, 3, contrib.lcd, {
//     label: 'LCD Test',
//     segmentWidth: 0.06,
...
//   let errorsLine = grid.set(0, 6, 4, 3, contrib.line, {
...
//   let transactionsLine = grid.set(0, 0, 6, 6, contrib.line, {
//     showNthLabel: 5,
//     maxY: 100,
...
//   let map = grid.set(6, 0, 6, 6, contrib.map, { label: 'Servers Location' });

//   let log = grid.set(8, 6, 4, 2, contrib.log, {
//     fg: 'green',
//     selectedFg: 'green',
//     label: 'Server Log',
//   });
...
//   // dummy data
//   let servers = ['US1', 'US2', 'EU1', 'AU1', 'AS1', 'JP1'];
//   let commands = [
//     'grep',
//     'node',
//     'java',
...
//     }
//     donut.setData([
//       { label: 'Server', percent: parseFloat((pct + 0.0) % 1).toFixed(2), color },
//       { label: 'Manager', percent: parseFloat((pct + 0.0) % 1).toFixed(2), color },
//       { label: 'Preview', percent: parseFloat((pct + 0.0) % 1).toFixed(2), color },
//     ]);
//     pct += 0.01;
//   }
