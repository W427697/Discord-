...
import React, { forwardRef, HTMLAttributes, memo, ReactNode, RefObject, useEffect } from 'react';
...
export const TabButton = memo(
  forwardRef(
    (
      ...
      const { ref: innerRef, rect } = useDOMRect({ live: true });
