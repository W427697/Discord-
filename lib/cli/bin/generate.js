...
switch (projectType) {
  ...
  case types.REACT:
    ...
    require('../generators/REACT').default
      .default.then(commandLog('Adding storybook support to your "React" app'))
      .then(end)
      .catch(handleError);
    break;
  ...
  case types.METEOR:
    ...
    require('../generators/METEOR').default
      .default.default.then(commandLog('Adding storybook support to your "Meteor" app'))
      .then(end)
      .catch(handleError);
    break;
  ...
  case types.WEBPACK_REACT:
    ...
    require('../generators/WEBPACK_REACT').default
      .default.default.then(commandLog('Adding storybook support to your "Webpack React" app'))
      .then(end)
      .catch(handleError);
    break;
  ...
  case types.REACT_PROJECT:
    // eslint-disable-next-line
    require('../generators/REACT').default
      .default.then(commandLog('Adding storybook support to your "React" library'))
      .then(end)
      .catch(handleError);
    break;
  ...
  case types.SFC_VUE:
    ...
    require('../generators/SFC_VUE').default
      .default.then(commandLog('Adding storybook support to your "Single File Components Vue" app'))
      .then(end)
      .catch(handleError);
    break;
