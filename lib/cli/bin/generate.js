...
(function runGenerator(projectType) {
  switch (projectType) {
    ...
    default:
      ...
      inquirer
        .prompt([
          {
            ...
            choices: [
              {
                name: 'React (using Create React App)',
        ...
        .then(({ type, vueTemplate, dirname }) => {
          switch (type) {
            case types.REACT_SCRIPTS:
              runCreator(npmOptions, 'react-app', dirname);
              break;
            case types.REACT_NATIVE_SCRIPTS:
              runCreator(npmOptions, 'react-native-app', dirname);
              break;
            case types.SFC_VUE:
              installGlobal(npmOptions, 'vue-cli');
