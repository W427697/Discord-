...
import { version, description } from '@material/textfield/package.json';
...
const documentation = {
  ...
  description,
  version,
  requirement: `yarn add @material/textfield`,
  usage: [
    {
      title: 'index.js',
      code: `
...
class TextField extends Component<Props> {
  ...
  render = () => {
    ...
    const fixedLabelClass: string =
      hasValue || document.activeElement === this.input
...
class App extends Component<{}, { text: string, helpText: string }> {
  state = {
    text: '',
  }
  render() {
...
export default Elements.add('TextField', () => <DocPage {...documentation} material />);
