...
//   ParsedLocalStorageShortcutkeys,
//   ShortcutkeyState,
// } from './shortcutModels';
...
// import { Keybinding, KeyCode, KeyCodeUtils, ResolvedKeybinding, SimpleKeybinding } from '../keyboard/keyCodes';
// import { IKeyboardEvent,StandardKeyboardEvent } from '../keyboard/keyboardEvent';
...
// function toShortcutState(shortcutKeys: ParsedLocalStorageShortcutkeys): ShortcutkeyState {
//   return Object.entries(shortcutKeys).reduce(
//     (acc, [feature, shortcut]) =>
//       fixedShortcuts.includes(feature)
//         ? acc
//         : { ...acc, [feature]: { shortcut: mapShortcut(shortcut), error: false } },
//     {}
//   );
// }

// type ShortcutScreenState = {
// 	activeFeature: string
// 	successField: string
// 	shortcutKeys: ShortcutkeyState
// }

// type ShortcutScreenProps = {
//   restoreAllDefaultShortcuts: Promise<ParsedLocalStorageShortcutkeys>
//   restoreDefaultShortcut: Promise<string>
//   setShortcut: Promise<ParsedLocalStorageShortcutkeys>
//   shortcutKeys: ParsedLocalStorageShortcutkeys
// }

// class ShortcutsScreen extends Component<ShortcutScreenProps,, ShortcutScreenState> {
//   constructor(props: ShortcutScreenProps) {
//     super(props);
...
//     const shortcut = this.resolveKeyboardEvent(evt)
