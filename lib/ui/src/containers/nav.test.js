...
describe('collapse all stories', () => {
  describe('no selected story', () => {
    it('collapses normal stories', () => {
      const collapsed = collapseAllStories(stories, null);
    ...
    it('collapses docs-only stories', () => {
      ...
      const filtered = collapseAllStories(hasDocsOnly, null);
      expect(filtered.a1).toEqual({
        id: 'a1',
        isComponent: true,
        isLeaf: true,
  ...
  describe('selected story', () => {
    it('collapses normal stories', () => {
      const collapsed = collapseAllStories(stories, 'a1');
      expect(collapsed).toEqual({
        a: {
          id: 'a',
          isComponent: true,
