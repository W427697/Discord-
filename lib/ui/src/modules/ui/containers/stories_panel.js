...
const AddonPanelContainer = compose(genPoddaLoader(mapper))(StoriesPanel);
AddonPanelContainer.shouldShow = ({ showExplorer }) => showExplorer;

export default AddonPanelContainer;
