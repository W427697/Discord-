...
export function getShortcuts(platform) {
  ...
  if (platform && platform.indexOf('mac') !== -1) {
    return [
      ...
      { name: 'Toggle Fullscreen', keys: ['⌘ ⇧ F', '⌃ ⇧ F'] },
      { name: 'Toggle Explorer', keys: ['⌘ ⇧ L', '⌃ ⇧ L'] },
      { name: 'Toggle Addons', keys: ['⌘ ⇧ D', '⌃ ⇧ D'] },
  ...
  return [
    ...
    { name: 'Toggle Fullscreen', keys: ['Ctrl + Shift + F'] },
    { name: 'Toggle Explorer', keys: ['Ctrl + Shift + L'] },
    { name: 'Toggle Addons', keys: ['Ctrl + Shift + D'] },
