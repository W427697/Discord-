...
const normalPreviewStyle = theme => ({
  width: '100%',
  height: '100%',
...
const fullScreenPreviewStyle = theme => ({
  position: 'fixed',
  left: '0px',
  right: '0px',
  top: '0px',
...
class Layout extends React.Component {
  ...
  render() {
    ...
    let previewStyle = normalPreviewStyle(theme);

    if (goFullScreen) {
      previewStyle = fullScreenPreviewStyle(theme);
    }
        ...
        >
          ...
          >
            <div style={contentPanelStyle(downPanelInRight, leftPanelOnTop)}>
              ...
              <Dimensions {...previewPanelDimensions} theme={theme} />
            </div>
            {conditionalRender(
              showDownPanel,
              () =>
