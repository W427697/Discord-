  ...
  renderOptions() {
    ...
    const shorcuts = (
      <div
        ...
        className="floating-menu-button"
      >
        <img style={iconStyle} src={svg.help} alt="?" />
        ...
        <div style={blockStyle}>
          ...
          <div style={btnsStyle}>
            ...
            <div onClick={this.handleOption(features.NEXT_STORY)}>
              <img style={iconStyle} src={svg.skip_next} alt="next" title="next story" />
            </div>
            <div onClick={this.handleOption(features.NEXT_KIND)}>
              <img style={iconStyle} src={svg.fast_forward} alt="next" title="next story group" />
            </div>
          </div>
        </div>
      </div>
