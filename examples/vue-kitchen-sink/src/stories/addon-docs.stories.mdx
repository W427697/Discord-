...
## SFC Syntax is supported

You can also write stories in Vue SFC syntax.

<Preview>
<Story name="SFC Syntax">
```vue
<template>
  <my-button :rounded="false" @click="countUp">Counter {{ counter }}</my-button>
</template>
<script>
  export default {
    methods: {
