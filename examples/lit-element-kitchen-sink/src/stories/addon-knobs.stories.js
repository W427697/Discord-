...
const cachedContainer = document.createElement('simple-message');
...
export const Simple = () => {
  ...
  return `<simple-message message='${content}'></simple-message>`;
};

export const DOM = () => {
  const name = text('Name', 'John Doe');
  const container = document.createElement('simple-message');
...
export const story4 = () => {
  ...
  return `<div style="${style}">
        ...
        <simple-message message='${stockMessage}'></simple-message>
        <simple-message message='Also, I have:'></simple-message>
        <ul>${items.map(item => `<li>${item}</li>`).join('')}</ul>
        <simple-message message='${salutation}'></simple-message>
      </div>
    `;
};
