...
Once the story loads, Storybook infers the relevant metadata (e.g., [`args`](../02-writing-stories/args.md), [`argTypes`](../10-api/arg-types.md), [`parameters`](../02-writing-stories/parameters.md)) and automatically generates a documentation page with this information positioned at the root-level of your component tree in the sidebar.
