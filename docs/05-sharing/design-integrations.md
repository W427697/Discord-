...
In Storybook, add a new [parameter](../02-writing-stories/parameters.md) named `design` to your story and paste the Figma URL. For example:
...
- [Addon documentation](../07-addons/index.md)
