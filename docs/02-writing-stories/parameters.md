...
We can also set the parameters for **all stories** via the `parameters` export of your [`.storybook/preview.js`](../08-configure/index.md#configure-story-rendering) file (this is the file where you configure all stories):
...
If you are defining an API that relies on parameters (e.g. an [**addon**](../07-addons/index.md)) it is a good idea to take this behavior into account.
