...
When organizing your Storybook, there are two methods of structuring your stories: **implicit** and **explicit**. The [implicit method](../08-configure/sidebar-and-urls.md#csf-30-auto-titles) involves relying upon the physical location of your stories to position them in the sidebar, while the [explicit method](#naming-stories) involves utilizing the `title` parameter to place the story.
...
- **Docs**: The automatically generated [documentation page](../03-writing-docs/autodocs.md) for the component
