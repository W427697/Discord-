...
- All the data for the story is encoded in the args of the story, which works well with other parts of Storybook's tooling (e.g. [controls](../06-essentials/controls.md)).
...
Finally, update your [`.storybook/main.js|ts`](../08-configure/index.md#using-storybook-api) to allow Storybook to load the generated mock service worker file as follows:
...
Add the decorator you've just implemented to your [`storybook/preview.js`](../08-configure/index.md#configure-story-rendering):
