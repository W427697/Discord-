...
Storybook is packaged as a small, development-only, [workshop](https://bradfrost.com/blog/post/a-frontend-workshop-environment/) that lives alongside your app. Install it by [running a command](../01-get-started/install.md).
...
If you’re using a niche framework or a recently launched tool, we might not have an integration for it yet. Consider creating a [proof of concept](../07-addons/writing-addons.md) yourself first to lead the way for the rest of the community.
...
Isolate components and pages and track their use cases as [stories](../02-writing-stories/index.md). Verify hard-to-reach edge cases of UI. Use addons to mock everything a component needs—context, API requests, device features, etc.

**✅ Test UIs with less effort and no flakes**

Stories are a pragmatic, reproducible way of tracking UI states. Use them to spot-test the UI during development. Storybook offers built-in workflows for automated [Accessibility](../04-writing-tests/accessibility-testing.md), [Interaction](../04-writing-tests/interaction-testing.md), and [Visual](../04-writing-tests/visual-testing.md) testing. Or use stories as test cases by importing them into other JavaScript testing tools.

**📚 Document UI for your team to reuse**

Storybook is the single source of truth for your UI. Stories index all your components and their various states, making it easy for your team to find and reuse existing UI patterns. Storybook also auto-generates [documentation](../03-writing-docs/index.md) from those stories.

**📤 Share how the UI actually works**

Stories show how UIs actually work, not just a picture of how they're supposed to work. That keeps everyone aligned on what's currently in production. [Publish Storybook](../05-sharing/publish-storybook.md) to get sign-off from teammates. Or [embed](../05-sharing/embed.md) them in wikis, Markdown, and Figma to streamline collaboration.
