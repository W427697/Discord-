...
Update your Storybook configuration (in [`.storybook/main.js|ts`](../08-configure/index.md#configure-story-rendering)) to include the Essentials addon.
...
|                                | `mdxPluginOptions` | Provides additional configuration options and plugin configuration for [MDX documentation](../03-writing-docs/mdx.md#lack-of-github-flavored-markdown-gfm). |
...
If you need to disable any of the Essential's addons, you can do it by changing your [`.storybook/main.js`](../08-configure/index.md#configure-story-rendering) file.
