...
Run your first test. Storyshots will recognize your stories (based on [.storybook/main.js's setup](../08-configure/story-rendering.md)) and save them in the **snapshots** directory.
