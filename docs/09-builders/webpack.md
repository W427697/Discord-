...
If you intend to debug the Webpack configuration used by Storybook, you can use the Storybook CLI to help you. If you're running in [development mode](../10-api/cli-options.md#dev), you can use the following command:
...
Additionally, if you're generating a [static build](../10-api/cli-options.md#build) of your Storybook, you can use the following command:
