...
- Run the relevant [automigrations](../13-migration-guide.md#automatic-upgrade) factoring in the [breaking changes](../13-migration-guide.md#major-breaking-changes) between your current version and the latest stable version
