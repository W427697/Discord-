...
Update the [`@junk-temporary-prototypes/ember-cli-storybook`](https://www.npmjs.com/package/@junk-temporary-prototypes/ember-cli-storybook) package to the latest version to fix it.
