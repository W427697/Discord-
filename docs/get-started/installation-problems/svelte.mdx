...
- Add the [`@junk-temporary-prototypes/addon-svelte-csf`](https://storybook.js.org/addons/@junk-temporary-prototypes/addon-svelte-csf/) addon as development dependency.
