...
describe('Version', () => {
  ...
  const MANAGER_API_VERSION_PATH = join(CODE_DIR_PATH, 'lib', 'manager-api', 'src', 'version.ts');
  const VERSIONS_PATH = join(CODE_DIR_PATH, 'lib', 'core-common', 'src', 'versions.ts');
