// From GIST https://gist.github.com/nfantone/1eaa803772025df69d07f4dbf5df7e58

/* eslint-disable no-await-in-loop */
/* eslint-disable no-restricted-syntax */
type BeforeShutdownListener = (ev: string) => void;
 ...
 */
const processOnce = (signals: string[], fn: (ev: string) => void) => {
