...
-   [From version 3.4.x to 4.0.x](#from-version-34x-to-40x)
    ...
    -   [Removed WithEvents](#removed-with-events)
...
Removed the `WithEvents` component from `@storybook/addon-events`. See package [README](https://github.com/storybooks/storybook/blob/master/addons/events/README.md) for the proper usage.
