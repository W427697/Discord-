...
- [From version 7.x to 8.0.0](#from-version-7x-to-800)
  - [Drop support for Vue 2](#drop-support-for-vue-2)
...
- [From version 7.5.0 to 7.6.0](#from-version-750-to-760) - [Primary doc block accepts of prop](#primary-doc-block-accepts-of-prop)
...
Vue 2 has reached EOL in 2023-12-31. Therefore, Storybook 8 has dropped support for Vue 2. The frameworks `@storybook/vue-vite` and `@storybook/vue-webpack5` are not available anymore. Please use `@storybook/vue3-vite` and `@storybook/vue3-webpack5` instead. We have also removed the preset package `@storybook/preset-vue-webpack` and the renderer package `@storybook/vue`.
