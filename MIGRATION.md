...
In 6.x the following configuration would sort any story/doc containing the title segement `Introduction` to the top of the sidebar, so this would match `Introduction`, `Example/Introduction`, `Very/Nested/Introduction`, etc.
