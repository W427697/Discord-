...
import { normalizeStoriesEntry } from '../../core-common';
import type { NormalizedStoriesSpecifier, StoryIndexEntry } from '../../types';
import { readCsf, getStorySortParameter } from '../../csf-tools';
import { toId } from '@storybook/csf';
import { logger, once } from '../../node-logger';
...
vi.mock('../../csf-tools', async (importOriginal) => {
  const csfTools = await importOriginal<typeof import('../../csf-tools')>();
  return {
    ...csfTools,
