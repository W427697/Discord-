...
import { styled, useTheme, type StorybookTheme } from '../../theming';
import { Form, IconButton, Button } from '../../components';
...
const getCustomStyleFunction: (theme: StorybookTheme) => JsonTreeProps['getStyle'] =
  (theme) => () => ({
    name: {
