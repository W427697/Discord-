...
//   - ie. from`renderToRoot()` (stories) or`ReactDOM.render()` (docs) in.
...
beforeEach(() => {
  ...
  projectAnnotations.renderToRoot.mockReset();
...
describe('PreviewWeb', () => {
  describe('initial render', () => {
    it('renders story mode through the stack', async () => {
      ...
      projectAnnotations.renderToRoot.mockImplementationOnce(
