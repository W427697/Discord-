  ...
  constructor(
    ...
    if (options.storyIndexers.length > 1) {
      deprecate(
        ...
        Please refer to the migration guide at https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#storyindexers-is-replaced-with-experimental_indexers`
      );
    }
  }
