import type { Options, StorybookConfig as StorybookConfigBase } from '@storybook/core/dist/types';

export type { Options, Preset, BuilderResult, TypescriptOptions } from '@storybook/core/dist/types';
