...
const baseTemplates = {
  ...
  'react-vite/default-js': {
    name: 'React Vite (JS)',
    script: 'npm create vite@beta . --template react',
    expected: {
  ...
  'react-vite/default-ts': {
    name: 'React Vite (TS)',
    script: 'npm create vite@beta . --template react-ts',
    expected: {
      framework: '@storybook/react-vite',
      renderer: '@storybook/react',
      builder: '@storybook/builder-vite',
  ...
  'vue3-vite/default-js': {
    name: 'Vue3 Vite (JS)',
    script: 'npm create vite@beta . --template vue',
    expected: {
  ...
  'vue3-vite/default-ts': {
    name: 'Vue3 Vite (TS)',
    script: 'npm create vite@beta . --template vue-ts',
    expected: {
      framework: '@storybook/vue3-vite',
      renderer: '@storybook/vue3',
      builder: '@storybook/builder-vite',
  ...
  'html-vite/default-js': {
    name: 'HTML Vite JS',
    script:
      'npm create vite@beta . --template vanilla && echo "export default {}" > vite.config.js',
    expected: {
  ...
  'html-vite/default-ts': {
    name: 'HTML Vite TS',
    script:
      'npm create vite@beta . --template vanilla-ts && echo "export default {}" > vite.config.js',
    expected: {
      framework: '@storybook/html-vite',
      renderer: '@storybook/html',
      builder: '@storybook/builder-vite',
  ...
  'svelte-vite/default-js': {
    name: 'Svelte Vite (JS)',
    script: 'npm create vite@beta . --template svelte',
    expected: {
  ...
  'svelte-vite/default-ts': {
    name: 'Svelte Vite (TS)',
    script: 'npm create vite@beta . --template svelte-ts',
    expected: {
      framework: '@storybook/svelte-vite',
      renderer: '@storybook/svelte',
      builder: '@storybook/builder-vite',
  ...
  'lit-vite/default-js': {
    name: 'Lit Vite (JS)',
    script: 'npm create vite@beta . --template lit',
    expected: {
  ...
  'lit-vite/default-ts': {
    name: 'Lit Vite (TS)',
    script: 'npm create vite@beta . --template lit-ts',
    expected: {
      framework: '@storybook/web-components-vite',
      renderer: '@storybook/web-components',
      builder: '@storybook/builder-vite',
  ...
  'preact-vite/default-js': {
    name: 'Preact Vite (JS)',
    script: 'npm create vite@beta . --template preact',
    expected: {
  ...
  'preact-vite/default-ts': {
    name: 'Preact Vite (TS)',
    script: 'npm create vite@beta . --template preact-ts',
    expected: {
      framework: '@storybook/preact-vite',
      renderer: '@storybook/preact',
      builder: '@storybook/builder-vite',
