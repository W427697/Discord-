...
/**
 * Converts an object of arguments to a string of property bindings and excludes undefined values.
 ...
 *  render: (args) => ({
 *    props: args,
 *    // Problem1: <example [input1]="input1" [input2]="input2"></example> This will set input2 to undefined and the internal default value will not be used.
 *    // Problem2: <example [input1]="input1"></example> The default value of input2 will be used, but it is not overridable by the user via controls.
