import { loadPreviewOrConfigFile, getFrameworkName } from '@storybook/core/dist/common';
...
export async function generateModernIframeScriptCode(options: Options, projectRoot: string) {
   ...
   */
  const code = `
  import { composeConfigs, PreviewWeb, ClientApi } from '@storybook/core/dist/preview-api';
