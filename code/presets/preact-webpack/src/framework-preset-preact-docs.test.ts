...
import * as preset from './framework-preset-preact-docs';

jest.mock('./requirer', () => ({
  requirer: (resolver: any, path: string) => path,
}));

describe('framework-preset-preact-docgen', () => {
          ...
          rules: [
            {
              ...
              loader: '@storybook/preset-preact-webpack/dist/loaders/react-docgen-loader',
