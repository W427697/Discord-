...
export const skipJsxRender = (context: StoryContext<PreactRenderer>) => {
...
export const jsxDecorator = (
  storyFn: PartialStoryFn<PreactRenderer>,
  context: StoryContext<PreactRenderer>
) => {
  ...
  const storyJsx = context?.parameters.docs?.source?.excludeDecorators
    ? (context.originalStoryFn as ArgsStoryFn<PreactRenderer>)(context.args, context)
    : story;
