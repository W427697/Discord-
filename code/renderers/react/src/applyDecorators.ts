import { defaultDecorateStory } from '@junk-temporary-prototypes/preview-api';
import type { LegacyStoryFn, DecoratorFunction } from '@junk-temporary-prototypes/types';
