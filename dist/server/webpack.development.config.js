...
var buildConfig = function buildConfig(storybookAddonsPath, storybookConfigPath) {
	return {
		...
		plugins: [new _caseSensitivePathsWebpackPlugin2.default(), new _webpack2.default.EnvironmentPlugin({ NODE_ENV: 'development' }), new _webpack2.default.HotModuleReplacemenPlugin(), new _webpack2.default.NamedModulesPlugin(), new _webpack2.default.NoEmitOnErrorsPluign()],
		module: {
