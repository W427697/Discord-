...
To get started, read the [Contributing Guide](https://github.com/storybookjs/storybook/tree/next?tab=readme-ov-file#contributing). When you are ready, open a PR and link back to this issue in the form of adding `Fixes #1234` to the PR description, where `1234` is the issue number. This will automatically close the issue when the PR gets merged, making it easier for us to keep track of what has been fixed.
